...
public class UpdatedTop10Movies {
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<Long, Double, Long>> sorted = env.readCsvFile("./data/ml-latest-small/ratings.csv")
                .ignoreFirstLine()
        ...
        DataSet<Tuple2<Long, String>> movies = env.readCsvFile("./data/ml-latest-small/movies.csv")
                .ignoreFirstLine()
                .parseQuotedStrings('"')
                .ignoreInvalidLines()
